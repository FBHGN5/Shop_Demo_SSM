	...
	<div id="box">
		<div id="zc"><div class="lab"><label>用&nbsp;&nbsp;户&nbsp;&nbsp;名</label><input type="text" id="us1" class="user" placeholder="您的用户名" >
			...
			<div class="lab"><label>设置密码</label><input id="us3" type="password" class="user" placeholder="您的密码">
				...
				<div class="lab"><label>验&nbsp;&nbsp;证&nbsp;&nbsp码</label><input id="cc" type="text" class="user" placeholder="请输入验证码"></div><p id="us8" style="position:absolute;top:385px;font-family:'Microsoft YaHei' ;"><img class="IMG" src="/resources/img/zc.png" style="">请输入验证码</p>
				<div id="title">
				</div>
				<div id=cs>
					<em>看不清？换一张</em>
